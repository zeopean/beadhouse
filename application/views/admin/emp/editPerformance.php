    ...
    <div class="col-md-12 main">
        ...
        <div class="col-md-6 content">
            <form role="form">
                ...
                <div class="form-group col-md-8">
                    <label for="name">奖惩类型</label><br/>
                    <input type="radio" name="optionsRadios"   value="option1" checked>&nbsp; 小功
                    <input type="radio" name="optionsRadios"   value="option1" >&nbsp;大功
                    <input type="radio" name="optionsRadios"   value="option1" >&nbsp;小功
                    <input type="radio" name="optionsRadios"   value="option1" >&nbsp;大过
                    <input type="radio" name="optionsRadios"   value="option1" >&nbsp;警告
